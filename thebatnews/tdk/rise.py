...
# from thebatnews.storing.module import MemoDocStore
...
# app.add_url_rule("/downloading/<filename>",
#                  methods=["GET"], view_func=prime.download)
# app.add_url_rule("/viewing", methods=["GET"], view_func=prime.view)
# app.add_url_rule("/viewing_timeseries",
#                  methods=["POST"], view_func=prime.view_timeseries)
# app.add_url_rule("/viewing_timeseries_plopics",
#                  methods=["POST"], view_func=prime.view_timeseries_plopics)
# app.add_url_rule("/viewing_timeseries_tropics",
#                  methods=["POST"], view_func=prime.view_timeseries_tropics)
# app.add_url_rule("/viewing_representation",
#                  methods=["POST"], view_func=prime.view_representation)
